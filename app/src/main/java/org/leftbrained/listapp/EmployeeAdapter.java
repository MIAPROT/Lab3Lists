...
public class EmployeeAdapter extends RecyclerView.Adapter<EmployeeAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull EmployeeAdapter.ViewHolder holder, int position) {
        ...
        textView.setText(String.valueOf(employee.getProeckt()));
        textView = holder.codeLinesTextView;
        textView.setText(String.valueOf(employee.getCode()));
        textView = holder.ratingTextView;
        textView.setText(String.valueOf(employee.getRaiting()));
